...
//         if(files.length > 3){
//             toast.warn("you can only upload 3 images")
//         }else{
//             setImages(files);
//         }
//     }
...
//         try {
//             await axios.post(`${import.meta.env.VITE_BASE_URL}/api/post/create-post`,formData,
//                 {
//                 headers: {
...
//             setPrice("");
//         } catch (error) {
//             toast.error("problem in create post api")
//         }
//     }
...
//                 className='w-[80%] p-3 border bg-white border-gray-300 rounded focus:outline-none focus:border-blue-500'
//                 required
//                 />
...
//                 <button type="submit" className='w-[81%] bg-blue-600 text-white p-3 rounded hover:bg-blue-700 transition duration-300'>
//                     Submit Post
//                 </button>
